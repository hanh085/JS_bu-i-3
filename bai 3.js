...
// 1. in mảng theo thứ tự index tăng dần
console.log('1. in mảng theo thứ tự index tăng dần: '); 
console.log(arrNumber.join(', ')); 
// 2. in mảng theo thứ tự index giảm dần
console.log('1. in mảng theo thứ tự index giảm dần: '); 
...
// 3. Xóa phần tử cuối cùng của mảng
console.log('3. Xóa phần tử cuối cùng của mảng: '); 
arrNumber.pop(); 
console.log(arrNumber.join(', ')); 

// 4. Xóa phần tử đầu tiên của mảng
console.log('4. Xóa phần tử đầu tiên của mảng: '); 
arrNumber.shift(); 
console.log(arrNumber.join(', ')); 

// 5. Thêm phần tử 0 vào cuối mảng
console.log('5. Thêm phần tử 0 vào cuối mảng: '); 
arrNumber.push(0); 
console.log(arrNumber.join(', ')); 

// 6. Thêm phần tử 0 vào đầu mảng
console.log('6. Thêm phần tử 0 vào đầu mảng: '); 
arrNumber.unshift(0); 
console.log(arrNumber.join(', ')); 

// 7. Cắt mảng từ phần tử đầu tiên đến phần tử thứ 5 thành 1 mảng mới
console.log('7. Cắt mảng từ phần tử đầu tiên đến phần tử thứ 5 thành 1 mảng mới: '); 
var arr7 = arrNumber.slice(0,6); 
console.log(arr7.join(', ')); 

// 8. Chèn thêm số 100 vào phần tử thứ 5 của mảng
console.log('8. Chèn thêm số 100 vào phần tử thứ 5 của mảng: '); 
arrNumber.splice(5,0,100); 
console.log(arrNumber.join(', ')); 

// 9. Thay thế phần tử thứ 5 bằng số 100
console.log('9. Thay thế phần tử thứ 5 bằng số 1000: '); 
arrNumber[5] = 1000; 
console.log(arrNumber.join(', ')); 

// 10. copy từ mảng arrNumber thành 1 mảng mới từ phần tử 5 đến hết
console.log('10. copy từ mảng arrNumber thành 1 mảng mới từ phần tử 5 đến hết: '); 
var arr10 = arrNumber.slice(-6); 
console.log(arr10.join(', ')); 

// 11. copy từ mảng arrNumber thành 1 mảng mới từ phần tử đầu tiên đến phần tử thứ 5
console.log('11. copy từ mảng arrNumber thành 1 mảng mới từ phần tử đầu tiên đến phần tử thứ 5: '); 
var arr11 = arrNumber.slice(0,6);
console.log(arr11.join(', ')); 

// 12. Nối mảng arrNumber2 vào mảng arrNumber
console.log('12. Nối mảng arrNumber2 vào mảng arrNumber: '); 
